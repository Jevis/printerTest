...
export default function AddCpmponent() {
    ...
    function addEncoder(encode: PrintData) {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column' ,marginBottom:'20px'}}>
            <div style={{ overflow: 'scroll', height: '800px', backgroundColor: '#282c34',paddingTop:'20px',paddingBottom:'20px',borderRadius:'10px' ,overflowX:'hidden'}}>
                {
                    ...
                    printeData.map((d, i) => {
                        return <div style={{ display: 'flex', flexDirection: 'row', height: '40px', width: 'calc(100vw - 220px)', marginBottom: '20px' ,backgroundColor:'white',borderRadius:'20px',marginLeft:'20px',marginRight:'20px',alignItems:'center'}}>
                            <div style={{flex:17,fontSize:'18px',color:'black',marginLeft:'20px',marginRight:'20px'}}>
                                <div style={{display:'flex'}}>
                                    {d.showText}
                                </div>
                            </div>
                            <EditAddButton initData={d} addEncoderListen={addEncoder}></EditAddButton>
            ...
            <EditAddButton initData={null} addEncoderListen={addEncoder}></EditAddButton>
